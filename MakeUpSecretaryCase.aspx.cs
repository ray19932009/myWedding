...
public partial class MakeUpSecretary : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        Label3.Text = "<li ><a  href='MakeUpSecretaryCase.aspx?subClass=0' class='btn dark_btn " + (Request["subClass"] == null || Request["subClass"] == "0" ? "selected" : "") + "'>新娘秘書全部</a></li><li><a href = 'MakeUpSecretaryCase.aspx?subClass=8' class='btn dark_btn " + (Request["subClass"] == "8" ? "selected" : "") + "'>整體造型</a></li><li><a href = 'MakeUpSecretaryCase.aspx?subClass=9' class='btn dark_btn " + (Request["subClass"] == "9" ? "selected" : "") + "'>新娘美甲美睫</a></li>";
    ...
    private void BindData排序(int subclass)
    {
        ...
        SqlDataAdapter da = new SqlDataAdapter("SELECT a.fIdServices,a.fIdStores,c.fIdGallery,c.fPhoto,a.fName,a.fDescription,a.fMaxMoney,a.fMinMoney,d.fPhoto as StorePhoto,d.fName as StoreName FROM tServices AS a inner join tServicesPic as b on a.fIdServices = b.fIdServices inner join tGalleryPhoto as c on c.fIdPhoto = b.fIdPhoto inner join tMember as d on a.fIdStores = d.fIdMember inner join tStores as e on d.fIdMember = e.fIdStores inner join tServicesSubClass as f on a.fIdSubServicesClass = f.fIdServicesSubClass inner join tServicesClass as g on f.fIdServicesClass = g.fIdServicesClass WHERE a.fDelete is null and g.fIdServicesClass = 3" + (subclass == 0 ? " order by fUploadTime desc" : " and  a.fIdSubServicesClass=" + Request["subClass"] + " order by fUploadTime desc"), conn);

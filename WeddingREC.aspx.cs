...
public partial class WeddingREC : System.Web.UI.Page
{
    ...
    {
        Label3.Text = "<li><a href='WeddingREC.aspx?subClass=0' class='btn dark_btn " + (Request["subClass"] == null || Request["subClass"] == "0" ? "selected" : "") + "'>婚禮全部</a></li><li><a href = 'WeddingREC.aspx?subClass=5' class='btn dark_btn " + (Request["subClass"] == "5" ? "selected" : "") + "'>婚禮攝影</a></li><li><a href = 'WeddingREC.aspx?subClass=6' class='btn dark_btn " + (Request["subClass"] == "6" ? "selected" : "") + "'>婚禮錄影</a></li> <li><a href = 'WeddingREC.aspx?subClass=7'  class='btn dark_btn " + (Request["subClass"] == "7" ? "selected" : "") + "'>婚禮MV</a></li>";
    ...
    private void BindData排序(int subclass)
    {
        ...
        //SqlConnection conn = new SqlConnection("Data Source=.;Initial Catalog=myWedding;User Id=sa;Password=as");
        //conn.Open();
        SqlDataAdapter da = new SqlDataAdapter("SELECT a.fIdGallery,a.fIdStores,a.fName as galleryName,a.fDescription,b.fPhoto,f.fPhoto as memberPhoto,f.fName as memberName From tGallery as a inner join tGalleryPhoto as b on a.fIdGallery = b.fIdGallery inner join tStores as c on a.fIdStores = c.fIdStores inner join tServicesSubClass as e on a.fIdServicesSubClass = e.fIdServicesSubClass inner join tServicesClass as d on d.fIdServicesClass = e.fIdServicesClass inner join tMember as f on f.fIdMember = a.fIdStores where a.fDelete is null and a.fIdPhotoCover = b.fIdPhoto" + (subclass == 0 ? "  and d.fIdServicesClass=2 order by fUploadTime desc" : " and  a.fIdServicesSubClass = " + Request["subClass"] + " order by fUploadTime desc"), conn);

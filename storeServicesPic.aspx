<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/MasterPage.master" CodeFile="storeServicesPic.aspx.cs" Inherits="storeServicesPic" %>
            ...
            <div class="tab-content colintabcontent">
                <div class="container" style="width: 100%; padding: 0;">
                    <div class="well" style="margin: 0 0 0 0; text-align: left; padding-left: 100px">
                        <!--更換封面-->
                        <h5>※必須先新增作品集與作品集相片才可挑選!</h5>

                        <!--更換封面-->
                        <br />
                        <div style="float: left; margin-left: 10%">
                            <asp:Label ID="Label3" runat="server" Text="請選擇要更換封面的方案"></asp:Label>
                            <asp:DropDownList ID="DropDownList1" AppendDataBoundItems="true" runat="server" DataTextField="fname1" DataValueField="fvalue1" AutoPostBack="True" Font-Size="20px" Height="35px" OnSelectedIndexChanged="DropDownList1_SelectedIndexChanged">
                                <asp:ListItem>請選擇</asp:ListItem>
                            </asp:DropDownList>
                        </div>
                        <div style="float: left; margin-left: 10%">
                            <asp:Label ID="Label5" runat="server" Text="請選擇由哪個作品集挑選"></asp:Label>
                            <asp:DropDownList ID="DropDownList2" AppendDataBoundItems="true" runat="server" DataTextField="fname" DataValueField="fvalue" OnSelectedIndexChanged="DropDownList2_SelectedIndexChanged1" AutoPostBack="True" Font-Size="20px" Height="35px">
                                <asp:ListItem>請選擇</asp:ListItem>
                            </asp:DropDownList>
                        </div><hr />
                        <br />
                        ...
                        <div style="height: 650px; overflow-y: auto;margin-right:10%; overflow-x: hidden;">                            

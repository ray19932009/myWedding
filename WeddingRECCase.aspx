<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="WeddingRECCase.aspx.cs" Inherits="WeddingREC" %>
        ...
        <div class="breadcrumb">
            <div class="wrap">
                 <div class="container-fluid">
                    <a href="Default.aspx"><i class="icon-home"></i>首頁</a><span>/</span>婚禮攝影
                </div>
            </div>
        </div>
        <!--MAIN CONTENT AREA-->
            ...
            <div class="container inner_content">
                <div id="options">
                    <ul id="filters" data-option-key="filter">
                            <li> <a href="WeddingREC.aspx?subClass=0" class="btn dark_btn ">
                            <asp:Label ID="Label4" runat="server" Text="作品集"></asp:Label></a></li>&nbsp;&nbsp;
                        <li  style="margin-right:70%"> <a href="WeddingRECCase.aspx?subClass=0" class="btn dark_btn liselected">

<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="TakeWeddingPicture.aspx.cs" Inherits="TakeWeddingPicture" EnableEventValidation="false" %>
            ...
            <div class="container inner_content" >
                <div id="options">
                    <ul id="filters" data-option-key="filter">
                       <li> <a href="TakeWeddingPicture.aspx?subClass=0" class="btn dark_btn liselected">
                            <asp:Label ID="Label4" runat="server" Text="作品集"></asp:Label></a></li>&nbsp;&nbsp;
                        <li  style="margin-right:70%"> <a href="TakeWeddingPictureCase.aspx?subClass=0" class="btn dark_btn">
                            <asp:Label ID="Label5" runat="server" Text="方案"></asp:Label></li></a>
                                                        ...
                                                        <tr>
                                                            <td>
                                                                <a href='gallery_1.aspx?fid=<%# Eval("fIdStores")%>&amp;gid=<%# Eval("fIdGallery") %>'>
                                                                    <asp:Image ID="Image1" runat="server" ImageUrl='<%# Eval("fPhoto") %>' style="background-size:contain;" Height="150px" ImageAlign="Middle" />
                                                                </a></td>
